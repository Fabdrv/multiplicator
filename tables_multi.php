...
<main>
    ...
    <h2>Présentation des tables mulyiples</h2>
    <p> cette page a pour fonction de te présenter plusieurs tables en simultané</p>

    <p class="fs-5 col-md-8"> sélectionnez plusieurs tables </p>
    <div class="mb-5">
        <!-- saisie du prénom -->
        <form method="POST" action="target_2.php">
            <p class="fs-5 col-md-8"> Prêt pour une petite révision ?</p>
            <div class="mb-5">
                <form method="POST" action="target_2.php">
